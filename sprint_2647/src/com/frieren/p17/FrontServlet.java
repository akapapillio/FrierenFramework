    ...
    private void injectDependencies(Object targetInstance) throws IllegalAccessException {
        for (Field field : targetInstance.getClass().getDeclaredFields()) {
            if (field.isAnnotationPresent(Autowired.class)) {
                ...
                Object dependency = findSingletonForType(fieldType);
                
                if (dependency != null) {
                    field.setAccessible(true);
                    field.set(targetInstance, dependency);
                    System.out.println("⚡ Dépendance injectée: " + dependency.getClass().getSimpleName() + " dans " + targetInstance.getClass().getSimpleName());
                } else {
